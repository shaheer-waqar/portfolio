...
function Navbar() {
  ...
  return (
    ...
    >
      ...
      <div className="">
        <motion.ul
          className={`flex fixed w-full h-[200px] left-0 bg-zinc-900 top-12 shadow-2xl border-t-[1px] border-zinc-800 gap-4 flex-col 
      ...
      <div className="flex items-center gap-2">
        <motion.div variants={navVarients}>
          <a
            href="https://github.com/shaheer-waqar"
            target="-blank"
            title="github"
